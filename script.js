    ...
    document.querySelector("#main").addEventListener("click",function(){
        if(!animating){
            ...
            gsap.to(h1s[index],{
                ...
                duration: 1,
                onComplete: function(){
                   gsap.set(this._targets[0], {top: "103%"});
                   animating = false;
                }
            });
